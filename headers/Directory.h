...
#define BANKNAME_AURALENGINE L"AuralEngine.bnk"
...
extern void saveCallback(Fl_Widget* widget, void* data);
extern void loadDataCallback(Fl_Widget* widget, void* data);
